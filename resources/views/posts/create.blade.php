...
@section('content')
    <div class="max-w-3xl mx-auto px-4 py-6">
        ...
        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            {{-- Use auth user ID in hidden input --}}
            ...
            <div>
                ...
                <textarea name="body" id="body" rows="5"
                    class="w-full mt-1 border-gray-300 rounded-md shadow-sm">{{ old('body') }}</textarea>
            </div>
            ...
            <div class="flex justify-end space-x-2">
                ...
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md shadow-sm">Create</button>
            </div>
        </form>
    </div>
@endsection
